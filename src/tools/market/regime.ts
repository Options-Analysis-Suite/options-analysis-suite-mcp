...
const STRESS_SCORE_RULE = '`label` is a state with hysteresis, not a band read off the score. '
  ...
  // before them. Nothing persists which prior a row took.
